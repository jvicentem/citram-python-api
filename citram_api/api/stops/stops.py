...
def get_stops_by_custom_search(custom_search):
    ...
    Example: get_stops_by_custom_search('tres aguas')
...
def get_stops_by_zip_code(postcode):
    ...
    Example: get_stops_by_zip_code(28922)
...
def get_stops_by_municipality(cod_municipality):
    ...
    Example: get_stops_by_municipality(Municipalities.FUENLABRADA.value)
...
def get_nearest_stops(latitude, longitude, distance, method=2):
    ...
    Example: get_nearest_stops(40.453053, -3.688344, 500.0)
